...
var style_DAINHAT_1 = function(feature, resolution){
    ...
    if (value >= 1.035714 && value <= 1.501709) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1.501709 && value <= 1.615944) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1.615944 && value <= 1.742308) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1.742308 && value <= 1.891228) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1.891228 && value <= 2.074074) {
            style = [ new ol.style.Style({
