...
map.getView().fit([9810998.099022, 2702749.964205, 9821703.440667, 2708234.258081], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">BETA INDEX</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (802 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'The Beta Index is a key metric used in network analysis to evaluate the connectivity of transportation or road networks. It is defined as the ratio of the number of links (roads) to the number of nodes (intersections or junctions) in the network:<br />This index provides a simple yet powerful indication of how well-connected a network is. A higher Beta Index means that, on average, each node is connected to more links, suggesting a denser and more navigable road system. Conversely, a lower Beta Index implies sparser connectivity, with fewer roads per intersection. Areas with high Beta Index values—indicating stronger connectivity and greater route availability—are shown in deep green. Areas with low Beta Index values—reflecting limited connectivity and potential bottlenecks—appear in light green.';
            }
